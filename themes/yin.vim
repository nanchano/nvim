...
call s:hi('SignColumn', s:palette.gray14, s:palette.black, 'none') "NEW
...
call s:hi('DiffAdd', s:palette.blackest, s:palette.gray07, '')
call s:hi('DiffChange', s:palette.blackest, s:palette.gray07, '')
call s:hi('DiffDelete', s:palette.blackest, s:palette.gray07, '')
